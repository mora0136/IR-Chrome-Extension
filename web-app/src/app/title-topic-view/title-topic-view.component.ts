...
@Component({
  selector: 'app-title-topic-view',
  templateUrl: './title-topic-view.component.html',
  styleUrls: ['./title-topic-view.component.css']
})
export class TitleTopicViewComponent implements OnInit {
  tabs: Tab[] = []
  groups: any = {}
  groupKeys: any = []
